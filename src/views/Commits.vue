...
const filteredCommits = computed(() => {
  let commits = metricsStore.commits

  if (authorFilter.value !== 'all') {
    commits = commits.filter((c) => c.author_name === authorFilter.value)
  }
  ...
  <MainLayout title="Commits">
    <div class="space-y-6">
      ...
      <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card class="p-4">
          <div class="text-sm text-muted-foreground">Total (30 dias)</div>
        ...
        <Card class="p-4">
          <div class="text-sm text-muted-foreground">Média/dia</div>
